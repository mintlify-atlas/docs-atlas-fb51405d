---
title: "Set Up Google OAuth Login for HealtyHelp"
sidebarTitle: "Google OAuth"
description: "Enable one-click Google sign-in for HealtyHelp using Passport.js, with automatic account linking and optional password setup."
---
