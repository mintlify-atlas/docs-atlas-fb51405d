---
title: "Manage Users, Roles, and Bans in HealtyHelp"
sidebarTitle: "User Management"
description: "API reference for listing, deleting, promoting, and banning HealtyHelp users from the admin panel, including ban fields and login behavior."
---
...
|---|---|---|---|
| Regular admin | ✗ (403) | ✗ (403) | Can demote/promote to user only |
